...
export function SplitStepShell({
  ...
  return (
    <div
      className={cn(
        isLanding
          ? 'mx-auto grid w-full max-w-[1184px] min-w-0 overflow-hidden rounded-[30px] border border-slate-200/80 bg-white/95 shadow-[0_30px_90px_-58px_rgba(15,23,42,0.35)] sm:rounded-[32px] lg:min-h-[760px] lg:grid-cols-[420px_minmax(0,1fr)]'
