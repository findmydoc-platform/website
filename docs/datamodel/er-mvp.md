...
erDiagram
    ...
    ClinicApplications {
        ...
        text address.street "Street name, required"
        text address.houseNumber "House number, required"
        number address.zipCode "Zip/postal code, required"
        text address.city "City, required"
        text address.country "Country, default: Turkey"
        ...
        relationship linkedRecords.clinic FK "Optional relationship to Clinics"
        relationship linkedRecords.basicUser FK "Optional relationship to BasicUsers"
        relationship linkedRecords.clinicStaff FK "Optional relationship to ClinicStaff"
        date linkedRecords.processedAt "Timestamp when materialized"
        text sourceMeta.ip "Captured submitter IP"
        text sourceMeta.userAgent "Captured user agent"
        date createdAt "System: timestamps: true"
        date updatedAt "System: timestamps: true"
    }
    ...
    Clinics {
        ...
        text address.street "Street name, required"
        text address.houseNumber "House number, required"
        number address.zipCode "Zip code, required"
        relationship city FK "Relationship to Cities, required"
        text contact.phoneNumber "Primary phone, required"
        email contact.email "Primary email, required"
    ...
    MedicalSpecialties {
        ...
        relationship featureImage FK "Relationship to PlatformContentMedia"
    ...
    MedicalSpecialties }o--|| PlatformContentMedia : "featureImage"
    ...
    MedicalSpecialties }o--|| PlatformContentMedia : "feature image asset"
