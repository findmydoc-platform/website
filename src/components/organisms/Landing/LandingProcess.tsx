    ...
    <section className="bg-white py-20">
      <Container>
        ...
        <div className="relative grid gap-12 lg:grid-cols-2">
          ...
          <div className="relative z-10">
            {/* Sticky list stays aligned with the sticky image; scroll triggers below drive state. */}
            <div className="sticky top-24">
              <div className="relative lg:pt-15 lg:pb-15">
                {/* Concave curve (bulge right) behind the dots */}
                <svg
                  className="absolute left-2 top-21 hidden w-24 lg:block text-border"
                  width="99"
                  height="615"
                  viewBox="0 0 99 615"
                  fill="none"
