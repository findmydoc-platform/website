...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "doctors_texts" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "clinictreatments" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "doctortreatments" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "doctorspecialties_certifications" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "favoriteclinics" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "review" ADD CONSTRAINT "review_patient_id_plattform_staff_id_fk" FOREIGN KEY ("patient_id") REFERENCES "public"."plattform_staff"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "patients_country_idx" ON "patients" USING btree ("country_id");
  CREATE INDEX IF NOT EXISTS "patients_profile_image_idx" ON "patients" USING btree ("profile_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "clinics_rels_tags_id_idx" ON "clinics_rels" USING btree ("tags_id");
  ...
  CREATE INDEX IF NOT EXISTS "doctors_texts_order_parent_idx" ON "doctors_texts" USING btree ("order","parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "treatments_rels_tags_id_idx" ON "treatments_rels" USING btree ("tags_id");
  CREATE INDEX IF NOT EXISTS "clinictreatments_clinic_idx" ON "clinictreatments" USING btree ("clinic_id");
  CREATE INDEX IF NOT EXISTS "clinictreatments_treatment_idx" ON "clinictreatments" USING btree ("treatment_id");
  CREATE INDEX IF NOT EXISTS "clinictreatments_updated_at_idx" ON "clinictreatments" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "clinictreatments_created_at_idx" ON "clinictreatments" USING btree ("created_at");
  CREATE UNIQUE INDEX IF NOT EXISTS "clinic_treatment_idx" ON "clinictreatments" USING btree ("clinic_id","treatment_id");
  CREATE INDEX IF NOT EXISTS "doctortreatments_doctor_idx" ON "doctortreatments" USING btree ("doctor_id");
  CREATE INDEX IF NOT EXISTS "doctortreatments_treatment_idx" ON "doctortreatments" USING btree ("treatment_id");
  CREATE INDEX IF NOT EXISTS "doctortreatments_updated_at_idx" ON "doctortreatments" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "doctortreatments_created_at_idx" ON "doctortreatments" USING btree ("created_at");
  CREATE UNIQUE INDEX IF NOT EXISTS "doctor_treatment_idx" ON "doctortreatments" USING btree ("doctor_id","treatment_id");
  CREATE INDEX IF NOT EXISTS "doctorspecialties_certifications_order_idx" ON "doctorspecialties_certifications" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "doctorspecialties_certifications_parent_id_idx" ON "doctorspecialties_certifications" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "doctorspecialties_doctor_idx" ON "doctorspecialties" USING btree ("doctor_id");
  CREATE INDEX IF NOT EXISTS "doctorspecialties_medical_specialty_idx" ON "doctorspecialties" USING btree ("medical_specialty_id");
  CREATE INDEX IF NOT EXISTS "doctorspecialties_updated_at_idx" ON "doctorspecialties" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "doctorspecialties_created_at_idx" ON "doctorspecialties" USING btree ("created_at");
  CREATE UNIQUE INDEX IF NOT EXISTS "doctor_medicalSpecialty_idx" ON "doctorspecialties" USING btree ("doctor_id","medical_specialty_id");
  CREATE INDEX IF NOT EXISTS "favoriteclinics_patient_idx" ON "favoriteclinics" USING btree ("patient_id");
  CREATE INDEX IF NOT EXISTS "favoriteclinics_clinic_idx" ON "favoriteclinics" USING btree ("clinic_id");
  CREATE INDEX IF NOT EXISTS "favoriteclinics_updated_at_idx" ON "favoriteclinics" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "favoriteclinics_created_at_idx" ON "favoriteclinics" USING btree ("created_at");
  CREATE UNIQUE INDEX IF NOT EXISTS "patient_clinic_idx" ON "favoriteclinics" USING btree ("patient_id","clinic_id");
  CREATE INDEX IF NOT EXISTS "review_patient_idx" ON "review" USING btree ("patient_id");
  ...
  CREATE INDEX IF NOT EXISTS "review_treatment_idx" ON "review" USING btree ("treatment_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_clinictreatments_id_idx" ON "payload_locked_documents_rels" USING btree ("clinictreatments_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_doctortreatments_id_idx" ON "payload_locked_documents_rels" USING btree ("doctortreatments_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_doctorspecialties_id_idx" ON "payload_locked_documents_rels" USING btree ("doctorspecialties_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_favoriteclinics_id_idx" ON "payload_locked_documents_rels" USING btree ("favoriteclinics_id");
