...
import ph1440x464 from '@/stories/assets/placeholder-1440-464.png'
    ...
    <section className="relative min-h-116 overflow-hidden bg-white py-20">
      ...
      <Container className="relative z-10">
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            <h2 className="mb-6 text-5xl font-bold text-foreground">Contact</h2>
          ...
          <div className="flex min-h-75 items-center justify-center rounded-lg bg-white p-8 shadow-lg">
            <p className="text-center text-4xl text-foreground">Placeholder for a funnel goes here</p>
          </div>
        </div>
      </Container>
    </section>
