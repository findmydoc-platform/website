import { BadgeCheck, Eye, Target, TrendingUp, Users } from 'lucide-react'
...
export const clinicTrust = {
  ...
  stats: [
    ...
    { value: 80, suffix: '+', label: 'Location filters', Icon: Target },
    { valueText: 'Direct', label: 'Clinic contact', Icon: Eye },
  ],
