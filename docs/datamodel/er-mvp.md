...
erDiagram
    ...
    Clinics {
        ...
        text internalPrimaryContact_firstName "Internal first contact given name"
        text internalPrimaryContact_lastName "Internal first contact family name"
        email internalPrimaryContact_email "Internal first contact email"
        select internalPrimaryContact_role "enum: Medical Director, Clinic Management, International Office"
