...
export const AUTH_CONFIG = {
   ...
   */
  REQUIRED_ENV_VARS: ['SUPABASE_URL', 'SUPABASE_ANON_KEY', 'SUPABASE_JWT_SECRET'] as const,
} as const
...
export function validateAuthEnvironment(): boolean {
  return AUTH_CONFIG.REQUIRED_ENV_VARS.every((envVar) => process.env[envVar] !== undefined)
}
