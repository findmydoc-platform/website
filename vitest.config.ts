...
import integrationThresholdConfig from './config/coverage/vitest.thresholds.integration.js'
import unitThresholdConfig from './config/coverage/vitest.thresholds.unit.js'
import storybookThresholdConfig from './config/coverage/vitest.thresholds.storybook.js'
    ...
    projects: [
      defineProject({
        ...
        test: {
          ...
          environment: 'node',
          testTimeout: 30000,
          globalSetup: './tests/setup/permissionMatrixUnitGlobalSetup.ts',
          hookTimeout: 60000,
