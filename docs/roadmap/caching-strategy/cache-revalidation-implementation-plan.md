...
| Cache inspector / invalidation visibility | Future dashboard widget or dashboard-ready module | `operational-scaling` for ops visibility | Shows recent invalidation decisions; not a product analytics surface. | Reads structured operational logs or planner output history. | Developer dashboard/admin owner. |
