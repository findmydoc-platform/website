...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE UNIQUE INDEX "platform_staff_email_idx" ON "platform_staff" USING btree ("email");
  CREATE INDEX "platform_staff_user_idx" ON "platform_staff" USING btree ("user_id");
